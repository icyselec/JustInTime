...
---@field update fun(self: self, ctrl: ui.Controller)
---@field onMouseMoved fun(self: self, x: number, y: number): boolean # if return truthy value, This should reference to the last propagated object.
---@field onMousePressed fun(self: self, x: number, y: number, button: number): boolean # if return truthy value, This should reference to the last propagated object.
---@field onMouseReleased fun(self: self, x: number, y: number, button: number): boolean # if return truthy value, This should reference to the last propagated object.
...
-- Component는 The Powder Toy의 UI Component와 비슷하다.
